    ...
    <section className={styles.wizard}>
      <div className={styles.wizardSteps}>
        ...
        <article className={completeStepClass(3)}>
          ...
          <strong className={styles.wizardStepMeta}>Open workspace</strong>
        </article>
      </div>

      {step === 1 ? (
        <Card
          description="Create your shared household before connecting accounts and imports."
      ...
      {step === 3 ? (
        <Card
          description="Your workspace is active and ready for the first household view."
          title="You are ready"
        >
          <div className={styles.pageSection}>
            <p className={styles.wizardMeta}>
              Household setup complete. Continue to Home to review the shared workspace.
            </p>
